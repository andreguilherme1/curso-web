...
function identificarFruta(fruta) {
    switch (fruta) {
        case "maçã":
            return "Não vendemos esta fruta aqui"
        case "kiwi":
            return "Estamos com escasse de kiwi"
        case "melancia":
            return "Aqui está são 3 reais o quilo"
        default:
            return "Não possuimos esta fruta"

    }
}

console.log(identificarFruta("maçã"))
console.log(identificarFruta("kiwi"))
console.log(identificarFruta("melancia"))
console.log(identificarFruta("manga"))