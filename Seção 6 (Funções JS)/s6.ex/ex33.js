...
let vetorInteiro = [1, 3, 7, 9]
let vetorString = ["maçã", "laranja", "limão", "melancia"]
let vetorDouble = [0.2, 0.5, 0.7, 0.9]
let vetorResultado = vetorInteiro.concat(vetorString.concat(vetorDouble))
